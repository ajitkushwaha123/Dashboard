          ...
          <ul className="flex flex-col justify-center items-start font-poppins">
            {sideBarLinks.map((nav, index) => {
              ...
              return (
                <div key={index}>
                  <li
                    className={`flex w-full justify-between items-center h-[44px] cursor-pointer hover:bg-primary rounded-lg group-hover:w-[233px] hover:text-white text-[20px] px-[14px] group-hover:px-[30px] my-[3px] ${
                      activeLink === nav.link ? "bg-primary text-white" : ""
                    }`}
